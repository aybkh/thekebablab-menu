...
const CategorySidebar = ({ categories, selectedCategory, onSelectCategory, isMobileVisible }) => {
    ...
    const getCategoryIcon = (name) => {
        ...
        if (lowerName.includes('batidos')) return '/categories/postres-y-batidos.webp';
        if (lowerName.includes('combo box')) return '/categories/combo-box.webp';
        ...
        if (lowerName.includes('pizza')) return '/categories/pizzas.webp';
        if (lowerName.includes('café') || lowerName.includes('cafe') || lowerName.includes('caliente')) return '/categories/bebidas-calientes.webp';
        if (lowerName.includes('postre') || lowerName.includes('tarta') || lowerName.includes('helado')) return '/categories/postres-y-batidos.webp';
        if (lowerName.includes('refresco') || lowerName.includes('agua') || lowerName.includes('bebida')) return '/categories/bebidas.webp';
        if (lowerName.includes('plato')) return '/categories/nuestros-platos.webp';
