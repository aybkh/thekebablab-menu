            ...
            <div className="marquee-container">
                ...
                {[...reviews, ...reviews].map((review, idx) => (
                    <div key={idx} className="review-card hover:scale-105 transition-transform duration-300 relative">
                        ...
                        <GoogleIcon className="google-icon-absolute" />
                        ...
                        <div className="flex gap-1 mb-2">
                            {[...Array(5)].map((_, i) => (
                                <Star key={i} size={14} fill={i < review.stars ? "var(--color-primary)" : "#e0e0e0"} color={i < review.stars ? "var(--color-primary)" : "#e0e0e0"} />
                            ))}
                        </div>
